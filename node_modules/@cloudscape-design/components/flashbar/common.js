...
export const handleFlashDismissedInternal = (dismissedId, items, refCurrent, flashRefsCurrent) => {
    ...
    if (nextItemIndex < 0 || nextItemIndex >= items.length) {
        const mainElement = (_a = document.querySelector('main')) !== null && _a !== void 0 ? _a : document.querySelector('[role="main"]');
        mainElement === null || mainElement === void 0 ? void 0 : mainElement.focus();
        return;
    }
    const nextItemId = (_b = items[nextItemIndex].id) !== null && _b !== void 0 ? _b : nextItemIndex;
