...
.awsui_placeholder_dwuol_1tb10_145:not(#\9) {
  color: var(--color-text-input-placeholder-dclg8u, #656871);
  font-style: italic;
}

.awsui_item_dwuol_1tb10_150:not(#\9) {
  display: flex;
  align-items: center;
}
.awsui_item_dwuol_1tb10_150 > .awsui_checkbox_dwuol_1tb10_154:not(#\9) {
  position: relative;
...
.awsui_option-group_dwuol_1tb10_163:not(#\9):not(:first-child) {
  margin-block-start: calc(-1 * var(--border-item-width-miijiw, 2px));
}

.awsui_filter_dwuol_1tb10_167:not(#\9) {
  z-index: 4;
  flex-shrink: 0;
}

.awsui_trigger_dwuol_1tb10_172:not(#\9) {
  white-space: nowrap;
  overflow: hidden;
  text-overflow: ellipsis;
}

.awsui_layout-strut_dwuol_1tb10_178:not(#\9) {
  inline-size: 100%;
  position: relative;
  transform: translate3d(0, 0, 0);
}

.awsui_list-bottom_dwuol_1tb10_184:not(#\9) {
  /* used in unit-tests */
}

.awsui_selected-icon_dwuol_1tb10_188:not(#\9) {
  color: var(--color-border-item-focused-uk47pl, #006ce0);
}

.awsui_show-label-tag_dwuol_1tb10_192 > .awsui_selected-icon_dwuol_1tb10_188:not(#\9) {
  padding-inline-start: var(--space-scaled-s-8ozaad, 12px);
}

.awsui_inline-token-trigger_dwuol_1tb10_196:not(#\9) {
  display: flex;
  flex-wrap: nowrap;
...
.awsui_inline-token-list_dwuol_1tb10_203:not(#\9) {
  display: flex;
  flex-wrap: nowrap;
  align-items: center;
...
.awsui_inline-token-list_dwuol_1tb10_203:not(#\9):dir(rtl) {
  mask-image: linear-gradient(-270deg, transparent, white 20px, white);
}
.awsui_inline-token-list_dwuol_1tb10_203 > .awsui_inline-token_dwuol_1tb10_196:not(#\9) {
  display: flex;
  align-items: center;
...
.awsui_visual-refresh_dwuol_1tb10_233 > .awsui_inline-token-list_dwuol_1tb10_203 > .awsui_inline-token_dwuol_1tb10_196:not(#\9) {
...
.awsui_inline-token-hidden-placeholder_dwuol_1tb10_240:not(#\9) {
  position: absolute !important;
  inset-block-start: -9999px !important;
  inset-inline-start: -9999px !important;
}

.awsui_inline-token-counter_dwuol_1tb10_246:not(#\9) {
  white-space: nowrap;
}

.awsui_inline-token-trigger--disabled_dwuol_1tb10_250 > .awsui_inline-token-list_dwuol_1tb10_203 > .awsui_inline-token_dwuol_1tb10_196:not(#\9) {
  border-color: var(--color-border-control-disabled-uj7t08, #dedee3);
  background-color: var(--color-background-container-content-6u8rvp, #ffffff);
  color: var(--color-text-disabled-rox5hg, #b4b4bb);
}

.awsui_inline-label-trigger-wrapper_dwuol_1tb10_256:not(#\9) {
  margin-block-start: -7px;
}

.awsui_inline-label-wrapper_dwuol_1tb10_260:not(#\9) {
  margin-block-start: calc(var(--space-scaled-xs-xwoogq, 8px) * -1);
}

.awsui_inline-label_dwuol_1tb10_256:not(#\9) {
...
.awsui_inline-label-inline-tokens_dwuol_1tb10_286:not(#\9) {
  padding-block-end: 0;
  transform: translateY(-1.5px);
}

.awsui_disabled-reason-tooltip_dwuol_1tb10_291:not(#\9) {
