...
export default function StatisticsBlock() {
  return (
    <Container header={<Header variant="h2">Statistical Features</Header>}>
      <ColumnLayout columns={4} variant="text-grid">
        <div>
          <Box variant="awsui-key-label">Items</Box>
          <div style={{ padding: "0.8rem 0", fontSize: "2.5rem" }}>13</div>
        </div>
        <div>
        ...
        <div>
          ...
          <div style={{ padding: "0.8rem 0", fontSize: "2.5rem" }}>22</div>
        </div>
        <div>
          <Box variant="awsui-key-label">Size</Box>
          <div style={{ padding: "0.8rem 0", fontSize: "2.5rem" }}>7</div>
        </div>
      </ColumnLayout>
    </Container>
  );
